...
import { JblogappAdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [JblogappSharedModule, JblogappAdminModule, RouterModule.forChild(ENTITY_STATES)],
...
export class JblogappBlogModule {}
